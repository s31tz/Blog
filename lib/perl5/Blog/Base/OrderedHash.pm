...
Blog::Base::OrderedHash - Hash mit geordneten Schlüsseln
...
Hash ist ein Hash, bei dem die Schlüssel/Wert-Paare eine definierte
Reihenfolge haben. Per Default ist dies die Hinzufügereihenfolge.
...
=head4 Synopsis
    ...
    @arr|$val = $oh->set(@keyVal);

=head4 Description

Setze die angegebenen Schlüssel/Wert-Paare. Die Methode liefert
keine Wert zurück.
