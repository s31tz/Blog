package Blog::Base::Html::Listing;
use base qw/Blog::Base::Html/;
...
Blog::Base::Html::Listing - Programm-Listing in HTML
...
=head1 SYNOPSIS
    ...
    my $obj = Blog::Base::Html::Listing->new(
        language=>'Perl',
        lineNumbers=>1,
        colNumbers=>79,
        source=>$file,
...
sub html {
    ...
    my $fh = Blog::Base::FileHandle->new('<',$source);
    for my $line (<$fh>) {
        chomp $line;
