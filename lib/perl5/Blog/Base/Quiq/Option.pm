...
Blog::Base::Quiq::Option - Verarbeitung von Programm- und Methoden-Optionen
...
Instantiierung eines Options-Objekts:
  ...
  sub meth {
      ...
      my $opt = Blog::Base::Quiq::Option->extract(\@_,
          -logLevel => 1,
          -verbose => 0,
      );
      ...
...
Das gelieferte Options-Objekt $opt ist eine Blog::Base::Quiq::Hash-Instanz.
...
sub extract {
    ...
    if ($varMode) {
        ...
        return Blog::Base::Quiq::Hash->new(\%opt);
    }
}
