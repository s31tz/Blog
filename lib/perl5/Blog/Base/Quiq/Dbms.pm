...
Blog::Base::Quiq::Dbms - Datenbanksystem
...
=head1 SYNOPSIS
  ...
  use Blog::Base::Quiq::Dbms;
  
  # Instantiierung
  my $d = Blog::Base::Quiq::Dbms->new($dbms);
  
  # Namen der unterstützten Datenbanksysteme
  my @names = Blog::Base::Quiq::Dbms->dbmsNames;
