...
Blog::Base::Quiq::Stacktrace - Generiere und visualisiere einen Stacktrace

=head1 SYNOPSIS

  use Blog::Base::Quiq::Stacktrace;
  
  my $st = Blog::Base::Quiq::Stacktrace->new; # generiere Stacktrace
  print $st->asString,"\n";       # visualisiere Stacktrace
  
  -or-
  
  print Blog::Base::Quiq::Stacktrace->asString,"\n"; # in einem Aufruf
...
erzeugt die Ausgabe
  ...
  main::a() [+17 ./test.pl]
    main::b() [+6 ./test.pl]
      main::c() [+10 ./test.pl]
        Blog::Base::Quiq::Stacktrace::asString() [+14 ./test.pl]
...
package Blog::Base::Quiq::Stacktrace;
