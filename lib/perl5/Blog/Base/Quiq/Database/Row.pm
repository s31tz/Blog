...
Blog::Base::Quiq::Database::Row - Basisklasse Datensatz (abstrakt)
...
Tabellenklasse bei Objekt-Datensätzen: C<< Blog::Base::Quiq::Database::ResultSet::Object >>

=item *

Tabellenklasse bei Array-Datensätzen: C<< Blog::Base::Quiq::Database::ResultSet::Array >>
...
sub tableClass {
    ...
    if (!$cache{$class}) {
        no strict 'refs';
        my $found = 0;
        for ($class,Blog::Base::Quiq::Perl->baseClassesISA($class)) {
...
Instanttierung über anonyme Datensatz-Klasse:
  ...
  $tab = Blog::Base::Quiq::Database::Row::Object->makeTable(
      [qw/per_id per_vorname per_nachname per_geburtsdatum/],
      qw/1 Rudi Ratlos 1971-04-23/,
      qw/2 Erika Mustermann 1955-03-16/,
      qw/3 Harry Hirsch 1948-07-22/,
