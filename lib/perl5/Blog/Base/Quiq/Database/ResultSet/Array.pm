...
Blog::Base::Quiq::Database::ResultSet::Array - Liste von Datensätzen in Array-Repräsentation

=head1 BASE CLASS

L<Blog::Base::Quiq::Database::ResultSet>
...
package Blog::Base::Quiq::Database::ResultSet::Array;
...
Liefere den Namen der Default-Rowklasse: 'Blog::Base::Quiq::Database::Row::Array'
...
sub defaultRowClass {
    return 'Blog::Base::Quiq::Database::Row::Array';
}
...
sub index {
    ...
    return wantarray? %idx: Blog::Base::Quiq::Hash->new(\%idx)->unlockKeys;
}
