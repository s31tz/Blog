...
Blog::Base::Quiq::Database::Cursor - Datenbank-Cursor
...
package Blog::Base::Quiq::Database::Cursor;
...
sub export {
    ...
    my $cpy = Blog::Base::Quiq::PostgreSql::CopyFormat->new($self->width);
    ...
    if ($cacheOp eq 'r') {
        ...
        if ($cacheOp eq 'w') {
            ...
            if (!$arr) {
                ...
                my $newCacheFile = $dir.'/'.
                    Blog::Base::Quiq::Digest->md5($self->{'stmt'});
