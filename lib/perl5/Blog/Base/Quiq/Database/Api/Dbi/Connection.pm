...
Blog::Base::Quiq::Database::Api::Dbi::Connection - DBI Datenbank-Verbindung
...
Ein Objekt der Klasse Blog::Base::Quiq::Database::Api::Dbi::Connection repräsentiert eine
...
sein (siehe Doku zu Blog::Base::Quiq::Database::Connection/sql).
...
sub sql {
    ...
    return Blog::Base::Quiq::Database::Api::Dbi::Cursor->new(
        sth => $sth,
        bindVars => $bindVars,
        db => $self,
        # titles => $titles,
