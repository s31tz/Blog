...
Blog::Base::Quiq::Database::Row::Array - Datensatz als Array
...
package Blog::Base::Quiq::Database::Row::Array;
...
our $TableClass = 'Blog::Base::Quiq::Database::ResultSet::Array'; # Default-Tabellenklasse
