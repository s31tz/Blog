...
Subklasse von Blog::Base::Quiq::Object ist.
...
sub parameters {
    ...
    my $argA = Blog::Base::Quiq::Parameters->extract(1,$p,undef,$paramA,$maxArgs,@_);
    if (@$argA < $minArgs) {
        $this->throw(
...
sub throw {
    ...
    if ($stacktrace) {
        ...
        my $stack = Blog::Base::Quiq::Stacktrace->asString;
        chomp $stack;
        $stack =~ s/^/    /gm;
        $str .= "Stacktrace:\n$stack\n";
    }
...
=head4 Example
  ...
  $path = Blog::Base::Quiq::Object->classFile;
  ==>
  <PFAD>Blog::Base::Quiq/Object.pm
...
=head4 Synopsis
  ...
  ($class,$self,$isClassMethod) = Blog::Base::Quiq::Object->this($this);
  $class = Blog::Base::Quiq::Object->this($this);
...
Klassenmethode, die als Objektmethode gerufen werden kann:
  ...
  sub mymethod {
      my $class = Blog::Base::Quiq::Object->this(shift);
      ...
  }
...
Objektmethode, die als Klassenmethode gerufen werden kann:
  ...
  sub myMethod {
      my ($class,$self,$isClassMethod) = Blog::Base::Quiq::Object->this(shift);
