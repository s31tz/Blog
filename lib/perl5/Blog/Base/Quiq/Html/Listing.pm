...
Blog::Base::Quiq::Html::Listing - Programm-Listing in HTML

=head1 BASE CLASS

L<Blog::Base::Quiq::Html::Base>
...
=head1 SYNOPSIS
  ...
  my $obj = Blog::Base::Quiq::Html::Listing->new(
      language => 'Perl',
      lineNumbers => 1,
      colNumbers => 79,
      source => $file,
...
package Blog::Base::Quiq::Html::Listing;
use base qw/Blog::Base::Quiq::Html::Base/;
...
sub html {
    ...
    my $fh = Blog::Base::Quiq::FileHandle->new('<',$source);
    for my $line (<$fh>) {
        chomp $line;
