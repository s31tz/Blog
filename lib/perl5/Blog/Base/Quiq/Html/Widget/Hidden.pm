...
Blog::Base::Quiq::Html::Widget::Hidden - Nicht sichtbares und nicht änderbares Formularelement
...
Html::Tag-Objekt instantiieren:
  ...
  $obj = Blog::Base::Quiq::Html::Tag->new;
...
package Blog::Base::Quiq::Html::Widget::Hidden;
