...
Blog::Base::Quiq::LineProcessor - Verarbeite Datei als Array von Zeilen
...
der Klasse Blog::Base::Quiq::LineProcessor::Line). Die Klasse stellt
...
=item -lineClass => $class (Default: 'Blog::Base::Quiq::LineProcessor::Line')
...
sub new {
    ...
    my $encoding;
    my $lineClass = 'Blog::Base::Quiq::LineProcessor::Line';
