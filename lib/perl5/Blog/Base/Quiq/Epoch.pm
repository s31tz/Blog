...
Blog::Base::Quiq::Epoch - Ein Zeitpunkt
...
Die Dauer wird wie beim Konstruktor von Blog::Base::Quiq::Duration angegeben.
...
sub minus {
    my ($self,$duration) = @_;
    $$self -= Blog::Base::Quiq::Duration->new($duration)->asSeconds;
    return $self;
}
...
wird wie beim Konstruktor von Blog::Base::Quiq::Duration angegeben.
...
=head4 Example
  ...
  Blog::Base::Quiq::Epoch->tzOffset; # MEST
  ==>
  7200
...
=head4 Example
  ...
  Blog::Base::Quiq::Epoch->new->epoch;
  ==>
  1464342621.73231
...
=head4 Example
  ...
  Blog::Base::Quiq::Epoch->new(1559466751)->localtime;
  ==>
...
=head4 Example
  ...
  Blog::Base::Quiq::Epoch->new->as('YYYY-MM-DD HH:MI:SS');
  =>
  2016-05-27 11:50:21
