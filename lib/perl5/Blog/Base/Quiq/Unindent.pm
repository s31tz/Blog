...
Blog::Base::Quiq::Unindent - Entferne Einrückung von "Here Document" oder String-Literal
...
Eingerücktes "Here Document":
  ...
  {
      $text = Blog::Base::Quiq::Unindent->hereDoc(<<'    EOT');
      Dies ist
      ein Text
      EOT
...
Eingerücktes mehrzeiliges String-Literal:
  ...
  {
      $text = Blog::Base::Quiq::Unindent->string('
          Dies ist
          ein Text
      ');
...
package Blog::Base::Quiq::Unindent;
...
Fortsetzungszeichen. Siehe Blog::Base::Quiq::String->joinLines().
...
sub hereDoc {
    ...
    if (defined $char) {
        $str = Blog::Base::Quiq::String->joinLines($char,$str);
    }
...
Varianten
  ...
  $text = Blog::Base::Quiq::Unindent->string(q~
      Dies ist
      ein Text
  ~);
  ...
  $text = Blog::Base::Quiq::Unindent->string(qq~
      Dies ist
      ein Text mit $variable
  ~);
...
Leerraum am Anfang und am Ende wird entfernt
  ...
  {
      $text = Blog::Base::Quiq::Unindent->trim("
...
Interne Anwendung
  ...
  sub select {
      ...
      $stmt = Blog::Base::Quiq::Unindent->trim($stmt);
      if ($self->debug) {
          warn $stmt,"\n";
      }
      ...
