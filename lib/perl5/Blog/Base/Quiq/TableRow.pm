...
Blog::Base::Quiq::TableRow - Tabellenzeile
...
einem Verweis auf die Tabelle (ein Objekt der Klasse Blog::Base::Quiq::Table)
...
der Klasse Blog::Base::Quiq::Table. Details siehe dort.

=cut

# -----------------------------------------------------------------------------

package Blog::Base::Quiq::TableRow;
