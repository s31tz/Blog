...
Blog::Base::Quiq::PlotlyJs::TimeSeries - Zeitreihen-Plot auf Basis von Plotly.js
...
package Blog::Base::Quiq::PlotlyJs::TimeSeries;
...
=head4 Example
  ...
  $url = Blog::Base::Quiq::PlotlyJs::TimeSeries->cdnUrl;
  ==>
