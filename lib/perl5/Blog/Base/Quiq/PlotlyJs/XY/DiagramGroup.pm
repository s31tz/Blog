...
Blog::Base::Quiq::PlotlyJs::XY::DiagramGroup - Gruppe von XY-Diagrammen
...
B<< Blog::Base::Quiq::PlotlyJs::XY::Diagram >> und definieren die Metadaten
...
sub html {
    ...
    my $titleY = Blog::Base::Quiq::Math->roundTo(
        1-($titleYOffset/$height),4); # Faktor für Titel-Position
    my $titleY2 = Blog::Base::Quiq::Math->roundTo(
        1-($height*(1-$titleY)/$height2),4);

    my $rangeSliderThicknessAsFraction = Blog::Base::Quiq::Math->roundTo(
    ...
    my $js = Blog::Base::Quiq::JavaScript->code(q°
    ...
    my $debugInfo = '';
    if ($debug) {
        $debugInfo = Blog::Base::Quiq::Html::Table::Simple->html($h,
            border => 1,
            cellpadding => 2,
            rows => [
...
sub htmlDiagram {
    ...
    return
        Blog::Base::Quiq::Html::Table::Simple->html($h,
        ...
        rows => [
            ...
            [[
                ...
                Blog::Base::Quiq::Html::Widget::CheckBox->html($h,
                     id =>  "$name-r$i",
                     class => 'rangeslider',
                     option => 1,
                     value => 0,
                ...
                ' | Shape: '.Blog::Base::Quiq::Html::Widget::SelectMenu->html($h,
                    ...
                    onChange => Blog::Base::Quiq::JavaScript->line(qq~
                ...
                ' | FillArea:'.Blog::Base::Quiq::Html::Widget::CheckBox->html($h,
                     id =>  "$name-f$i",
                     option => 1,
                     value => 1,
                     style => 'vertical-align: middle',
