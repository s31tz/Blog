package Blog::Base::Quiq::PlotlyJs::XY::Diagram;
...
Blog::Base::Quiq::PlotlyJs::XY::Diagram - Metadaten eines XY-Diagramms
...
das von der Klasse B<< Blog::Base::Quiq::PlotlyJs::XY::DiagramGroup >>
geplottet wird.
