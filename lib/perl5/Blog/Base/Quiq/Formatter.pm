...
Blog::Base::Quiq::Formatter - Formatierung von Werten
...
package Blog::Base::Quiq::Formatter;
...
sub geldbetrag {
    ...
    $x = Blog::Base::Quiq::Math->roundTo($x,2);
    $x = Blog::Base::Quiq::Formatter->readableNumber($x);
...
Keine gemeinsame Zeitkomponente:
  ...
  Blog::Base::Quiq::Formatter->reducedIsoTime(1558593179,1530940097);
  ==>
  2018-07-07 07:08:17

Jahr und Monat sind gemeinsam:

  Blog::Base::Quiq::Formatter->reducedIsoTime(1558593179,1558070991);
  ==>
  17 07:29:51

Alle Komponenten, bis auf die Sekunden, sind identisch:

  Blog::Base::Quiq::Formatter->reducedIsoTime(1558593179,1558593168);
  ==>
  48
...
sub reducedIsoTime {
    ...
    my @now = Blog::Base::Quiq::Epoch->new($now)->localtime;
    my @time = Blog::Base::Quiq::Epoch->new($time)->localtime;
