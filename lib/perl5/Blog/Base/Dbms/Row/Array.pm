package Blog::Base::Dbms::Row::Array;
use base qw/Blog::Base::Dbms::Row Blog::Base::Array/;
...
Blog::Base::Dbms::Row::Array - Datensatz als Array
...
our $TableClass = 'Blog::Base::Dbms::ResultSet::Array'; # Default-Tabellenklasse
...
$cur->fetch() Datensatzobjekte instanziiert. In dem Fall
