package Blog::Base::Dbms::Cursor;
use base qw/Blog::Base::Hash/;

use strict;
use warnings;

use Blog::Base::Dbms::Row::Array;
use Blog::Base::Dbms::Row::Object;
use Blog::Base::Dbms::ResultSet::Array;
use Blog::Base::Dbms::ResultSet::Object;
use Time::HiRes ();
...
Blog::Base::Dbms::Cursor - Datenbank-Cursor
...
sub new {
    ...
    my $self = $class->SUPER::new(
        ...
        rowOperation=>0,
        rowClass=>undef, # Blog::Base::Dbms::Database->defaultRowClass, # Initial. nötig?
        tableClass=>undef,
