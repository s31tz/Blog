package Blog::Base::Sdoc::Line;
use base qw/Blog::Base::TextFile::Line/;
...
Blog::Base::Sdoc::Line - Zeile eines Sdoc-Dokuments

=head1 BASE CLASS

L<Blog::Base::TextFile::Line|../../Blog::Base/TextFile/Line.html>
